...
const GEM_KEY1_PHYSICS_LINEAR_DAMP := 0.2
const GEM_KEY1_PHYSICS_ANGULAR_DAMP := 0.4
...
func _configure_item_physics() -> void:
	mass = GEM_KEY1_PHYSICS_MASS
	linear_damp = GEM_KEY1_PHYSICS_LINEAR_DAMP
	angular_damp = GEM_KEY1_PHYSICS_ANGULAR_DAMP
	can_sleep = true
