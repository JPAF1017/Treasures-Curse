...
const gem_key3_PHYSICS_LINEAR_DAMP := 0.2
const gem_key3_PHYSICS_ANGULAR_DAMP := 0.4
...
func _configure_item_physics() -> void:
	mass = gem_key3_PHYSICS_MASS
	linear_damp = gem_key3_PHYSICS_LINEAR_DAMP
	angular_damp = gem_key3_PHYSICS_ANGULAR_DAMP
	can_sleep = true
