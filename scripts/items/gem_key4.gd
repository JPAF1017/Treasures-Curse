...
const GEM_KEY4_PHYSICS_LINEAR_DAMP := 2.5
const GEM_KEY4_PHYSICS_ANGULAR_DAMP := 3.0
...
func _configure_item_physics() -> void:
	melee_shared.configure_item_physics(self, GEM_KEY4_PHYSICS_MASS, GEM_KEY4_PHYSICS_LINEAR_DAMP, GEM_KEY4_PHYSICS_ANGULAR_DAMP)
...
func _equip_to_right_hand(player: Node) -> void:
	...
	if attachment == null:
		push_warning("Could not attach gem_key4: right hand bone attachment is missing.")
		return
